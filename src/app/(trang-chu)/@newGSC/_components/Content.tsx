  ...
  return (
    <div className="flex flex-col justify-between gap-y-2">
      <div className="flex flex-col gap-y-0 sm:px-3">
        <h2 className="text-xl font-bold text-ui-text-800 sm:text-4xl">bảng tin gsc</h2>
        <p className="text-ui-small-note text-ui-text-600 sm:text-ui-note">
          Cùng xem những thông tin về Nendroid và Figure mới nhất của nhà Good Smile Company
        </p>
      </div>
